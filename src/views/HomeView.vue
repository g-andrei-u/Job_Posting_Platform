    ...
    <div v-if="popup" class="form-popup">
      <div class="form-job">
        <div style="grid-column: 1/3; grid-row: 1/2; display: flex; justify-content: flex-end; align-items: center;">
          <button @click="setPopup" style="background-color: white; font-size: 25px; border: 0px;">X</button>
        </div>

        <div class="form-description">
          <h1>Effortlessly hire top remote developers</h1>
          <br>
          <h4>🔥️ Hire in 72 hours (freelance) and 14 days (permanent).</h4>
          <h4>👍 Only 2.3% pass our technical & behavioral assessments.</h4>
          <br><br><br>
          <p>By creating an account, I agree to receive Jobs{} communications via email, and agree with the Arc Terms of Service, Privacy Policy, and Cookie Policy. I understand that I can unsubscribe at any time.</p>
        </div>
